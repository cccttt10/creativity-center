...
| 进阶课2        | 9.26 6PM - 10PM | 9.27 9AM - 1PM   | - React 进阶（2020/2021 新特性）<br/>- Project 3.2: macOS 计算器 <br/>- 模块化编程                                                                                                                 |
| 进阶课3        | 10.3 6PM - 10PM | 10.4 9AM - 1PM   | - 浏览器高级特性: Canvas 和事件监听<br/>- Project 3.3: macOS 画板                                                                                                                                 |
| 结课仪式        | 10.10 6PM - 8PM | 10.11 9AM - 11AM | - 持续学习: 后端/算法/数据结构/前端其他框架<br/>- 如何把 project 运用到简历/面试中<br/>- 优秀作品展示                                                                                                                  |
